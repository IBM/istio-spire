...
var (
	addrFlag      = flag.String("addr", ":9000", "address to bind the web server to")
	directFlag    = flag.String("direct", "echo:8081", "address to the echo server")
	envoyMTLSFlag = flag.String("envoy-to-envoy-mtls", "0.0.0.0:8001", "address to the envoy-to-envoy mTLS endpoint")
	envoyTLSFlag  = flag.String("envoy-to-envoy-tls", "0.0.0.0:8002", "address to the envoy-to-envoy TLS endpoint")
...
<body>
	<div class="button-grid-container">
		<div class="grid-item">
			<button onclick="location.assign('/?route=direct');">Send to Echo Server</button>
		</div>
	</div>
	<br/>
{{- if .WebHeader }}
